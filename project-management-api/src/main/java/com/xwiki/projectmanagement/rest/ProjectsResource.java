 ...
 * @since 1.0
 */
@Path("/wikis/{wikiName}/projectmanagement/{hint}/projects")
public interface ProjectsResource
{
     ...
     * @return a project model. HTTP 200: successful retrieval. HTTP 401: the user is not logged in. HTTP 403: the user
     *     does not have the rights to retrieve the work items.
     */
    @GET
    @Path("/{projectId}")
     ...
     * @param filter the filter that should match the returned projects.
