...
/**
 * Describes the user model of work package.
 *
 * @version $Id$
 * @since 1.0
 */
...
{
    /**
     * The key identifying the id property of the user.
     */
    public static final String KEY_ID = "id";

    /**
     * The key identifying the name property of the user.
     */
    public static final String KEY_NAME = "name";

    /**
     * @return the id of the work item user.
     */
    @JsonProperty
    ...
    /**
     * @return the name of the work item user.
     */
    @JsonProperty
