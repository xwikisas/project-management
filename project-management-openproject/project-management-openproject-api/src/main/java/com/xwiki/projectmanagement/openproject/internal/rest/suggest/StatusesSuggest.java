 ...
 */
@Component
@Named("com.xwiki.projectmanagement.openproject.internal.rest.suggest.StatusesSuggest")
@Singleton
@Path("/wikis/{wikiName}/openproject/instance/{instance}/statuses")
public class StatusesSuggest extends XWikiResource
{
    @Inject
