 ...
 */
@Component
@Named("com.xwiki.projectmanagement.openproject.internal.rest.suggest.TypeSuggest")
@Singleton
@Path("/wikis/{wikiName}/openproject/instance/{instance}/type")
public class TypeSuggest extends XWikiResource
{
    @Inject
