...
public interface OpenProjectApiClient
{
    ...
    /**
     * Retrieves the work packages matching a saved query.
     *
     ...
     * @param sortBy the sorting applied on top of the one defined by the query. When empty, the sorting of the query
     *     is kept.
     * @return the work packages matching the query.
     * @throws ProjectManagementException if some error was encountered while trying to retrieve the query.
     * @since 1.2.1
     */
    default PaginatedResult<WorkPackage> getQueryWorkPackages(String queryId, Integer offset, Integer pageSize,
        String sortBy) throws ProjectManagementException
    {
        throw new UnsupportedOperationException(
            "Retrieving the work packages of a saved query is not supported by this client implementation.");
    }

    /**
     * Retrieves the url returning the work packages that match a saved query. The url is generated by OpenProject and
     * already contains the columns, filters, sorting and pagination defined by the query. It is needed only when the
     * filters of the query have to be combined with other filters, otherwise
     * {@link #getQueryWorkPackages(String, Integer, Integer, String)} returns the results in a single request.
     *
     * @param queryId the id of the saved query.
     * @return the results url of the query, as found in its {@code _links.results.href}.
     * @throws ProjectManagementException if some error was encountered while trying to retrieve the query.
     * @since 1.2.1
     */
    default String getQueryResultsUrl(String queryId) throws ProjectManagementException
    {
        throw new UnsupportedOperationException(
            "Retrieving the results url of a saved query is not supported by this client implementation.");
    }
